...
class BannerActivity : ComponentActivity() {
    ...
    setContent {
      JetpackComposeDemoTheme {
        ...
        Surface(modifier = Modifier.fillMaxSize(), color = MaterialTheme.colorScheme.background) {
          BannerScreen(Companion.ADUNIT_ID)
        }
      }
    }
  }
  ...
  fun BannerScreenPreview() {
    JetpackComposeDemoTheme {
      // A surface container using the 'background' color from the theme
      Surface(modifier = Modifier.fillMaxSize(), color = MaterialTheme.colorScheme.background) {
        BannerScreen(InlineAdaptiveBannerActivity.ADUNIT_ID)
      }
    }
  }

  @Composable
  fun BannerScreen(adUnitID: String) {
    ...
    ScrollingScreen(
      ...
      content = {
        ...
        Text(text = "Example of a fixed sized banner ad view.")
