    ...
    setContent {
      JetpackComposeDemoTheme {
        ...
        Surface(modifier = Modifier.fillMaxSize(), color = MaterialTheme.colorScheme.background) {
          CollapsibleBannerScreen(ADUNIT_ID)
        }
      }
    }
  }
...
fun CollapsibleBannerScreenPreview() {
  JetpackComposeDemoTheme {
    // A surface container using the 'background' color from the theme
    Surface(modifier = Modifier.fillMaxSize(), color = MaterialTheme.colorScheme.background) {
      CollapsibleBannerScreen(InlineAdaptiveBannerActivity.ADUNIT_ID)
    }
  }
}

@Composable
fun CollapsibleBannerScreen(adUnitID: String) {
  ...
  ScrollingScreen(
    ...
    content = {
      ...
      Text(text = "Example of a collapsible banner ad view.")
